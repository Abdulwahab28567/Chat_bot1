...
#     data = json.load(file)
model = load_model(r'/home/abdulwahab/Downloads/abdelwhab/abdelwhab/Chatbot/Chatbot/SaveModels/model.h5')
tokenizer = pickle.load(open(r'/home/abdulwahab/Downloads/abdelwhab/abdelwhab/Chatbot/Chatbot/SaveModels/toknizer.pkl', 'rb'))
label_encoder = pickle.load(open(r'/home/abdulwahab/Downloads/abdelwhab/abdelwhab/Chatbot/Chatbot/SaveModels/label_encoder.pkl', 'rb'))
